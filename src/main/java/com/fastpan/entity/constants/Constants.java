package com.fastpan.entity.constants;
...
public class Constants {
    ...
    public static final String REDIS_KEY_DOWNLOAD = "fastpan:download:";

    public static final String REDIS_KEY_SYS_SETTING = "fastpan:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "fastpan:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "fastpan:user:file:temp:";
